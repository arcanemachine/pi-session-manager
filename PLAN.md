...
current_task: Task 7 — Full verification and user acceptance (prepared; not started)
...
- **Task 7 — Full verification and user acceptance:** Prepared; not started. Dispatch requires the user’s explicit approval after confirming that `pi-session-manager-worker` has been reset.
